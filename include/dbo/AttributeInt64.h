...
class CAttributeInt64 : public CAttributeGeneric
{
   DBO_DEF_CLASS_H;
   DBO_DEF_ATTR_H;
   DBO_PRI_CLASS_CTOR_H(CAttributeInt64);

   // make it copyable and assignable
public:
   CAttributeInt64(const CAttributeInt64&) DBO_NOTHROW ;
   CAttributeInt64& operator=(const CAttributeInt64&) DBO_NOTHROW ;
...
public:
   ...
   explicit CAttributeInt64(const dbo_uint32_t& index, const dbo_char_t* const iName) DBO_NOTHROW ;
   explicit CAttributeInt64(const dbo_uint32_t& index, const dbo_string_t& iName) DBO_NOTHROW ;
   explicit CAttributeInt64(const dbo_int64_t& iInt64, const dbo_uint32_t& index, const dbo_char_t* const iName) DBO_NOTHROW ;
   explicit CAttributeInt64(const dbo_int64_t& iInt64, const dbo_uint32_t& index, const dbo_string_t& iName) DBO_NOTHROW ;
   virtual ~CAttributeInt64() DBO_NOTHROW ;
...
protected:
   ...
   static dbo_int64_t* const Alloca() DBO_NOTHROW ;
   static void Dealloca(dbo_int64_t* phost) DBO_NOTHROW ;
};
